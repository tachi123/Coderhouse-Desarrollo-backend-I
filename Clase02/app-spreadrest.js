...
console.log(personaCompleta); // { nombre: 'Juan', edad: 30, calle: 'Av. Siempreviva', numero: 123 }

//Rest es como un recolector
let frutas = { manzana: 5, banana: 3, pera: 2, naranja: 4 };
let { manzana, ...otrasFrutas } = frutas;
console.log(otrasFrutas); // { banana: 3, pera: 2, naranja: 4 }
